    ...
    <div className="relative h-screen">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-normal lg:gap-28 h-full w-full bg-pink- text-white p-4 relative ">
        ...
        <div className="flex justify-center items-center flex-col">
          <h1 className="lg:text-6xl lg:w-[80%] w-[90%] text-5xl  font-bold mb-4 text-center text-white lg:leading-relaxed leading-none">
            Empowering <span className="text-orange-400"> Minds </span>  Inspiring
            <span className="text-green-600"> Futures</span>
          </h1>
          <p className="lg:text-4xl text-xl mb-8 text-center text-white">
